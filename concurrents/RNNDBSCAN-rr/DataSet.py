...
INPUT : 
    n_samples, INT
    n_features, INT : if n_features = 0 (default), n_features is random between 2 and 10
    n_centers, INT : if n_centers = 0 (default),  n_centers is random between 1 and min(10,n_features^2)
    noise, BOOL : True or Flase 
    p_noise, FLOAT (0.0%, 100%) : p_noise is the precentage of noise (label = -1)
